...
namespace isobus
{
	...
	enum class VirtualTerminalObjectType : std::uint8_t
	{
		...
		ObjectLabelReferenceList = 40, ///< Used to specify an object label.
		...
		Reserved_45 = 45, ///< Reserved (ISO-11783-6, not assigned)
		GraphicData = 46, ///< Used to define the data for a graphic image
		Reserved_47 = 47, ///< Reserved (ISO-11783-6, not assigned)
		...
		Reserved_255 = 255 ///< Reserved for future use. (See Clause D.14 Get Supported Objects message)
	};
